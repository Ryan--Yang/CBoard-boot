...
public class AdminController extends BaseController {
    ...
    public List<DashboardUser> getUserList() {
        List<DashboardUser> list = CUserDao.getUserList();
        return list;
    }
    ...
    public List<DashboardUserRole> getUserRoleList() {
        List<DashboardUserRole> list = CUserDao.getUserRoleList();
        return list;
    }
    ...
    public List<ViewDashboardBoard> getBoardList() {
        List<DashboardBoard> list = CBoardDao.getBoardListAdmin(tlUser.get().getUserId());
